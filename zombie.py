...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        a5=Action('도망',self.run_to_boy)

        c2 = Condition('좀비의 공의수가 소년보다 많은가?', self.is_boy_ball_many)
        SEQ_flee=Selector('도망',a5)
        SEQ_chase_boy = Sequence('소년보다 공이 많을경우 추적', c2, a4)
        SEQ_wander = Sequence('Wander', c1, a3, a2)
        wander_or_chase_or_flee_selector = Selector('배회 또는 추적 또는 도망', SEQ_wander, SEQ_chase_boy, SEQ_flee)
        root = Sequence('Behavior Tree', a3, wander_or_chase_or_flee_selector, a1)
